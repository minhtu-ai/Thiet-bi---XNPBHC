...
const AddProductionLineModal: React.FC<AddProductionLineModalProps> = ({ onClose, onAdd }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl w-full max-w-md transform transition-all">
        <div className="flex justify-between items-center p-4 border-b dark:border-slate-700">
          <h2 className="text-xl font-bold">Thêm dây chuyền sản xuất mới</h2>
        ...
        <form onSubmit={handleSubmit}>
          <div className="p-6">
            <label htmlFor="line-name" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
              Tên dây chuyền
            </label>
            <input
              id="line-name"
              ...
              placeholder="Ví dụ: Dây chuyền A"
              autoFocus
              required
            />
          </div>
